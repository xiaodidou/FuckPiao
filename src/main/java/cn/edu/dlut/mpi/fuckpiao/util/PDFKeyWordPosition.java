...
public class PDFKeyWordPosition extends PDFTextStripper {
  ...
  // 获取坐标信息
  public Map<String, List<Position>> getCoordinate(List<String> keywordList, PDDocument document)
      throws IOException {
  ...
  protected void writeString(String string, List<TextPosition> textPositions) throws IOException {
    for (String keyword : keywordList) {
      ...
      List<Position> positionList = positionListMap.computeIfAbsent(keyword,
          k -> new ArrayList<>());
